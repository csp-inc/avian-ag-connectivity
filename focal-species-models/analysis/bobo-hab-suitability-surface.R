#-----------------------------------------------------------
# PREP BOBOLINK HABITAT SUITABILITY SURFACE
...
inFile = paste0('output/bobo-random-forest-', mod_type,'-20220421.rda')
load(file = inFile, verbose = TRUE)
# Read in prediction dataset
load(file = 'data/ebird/bobo-pred-covs.rda', verbose = TRUE)
...
# save the raster
outFile = paste0('output/bobo-hab-suitability-', mod_type, '.tif')
